...
class TestCSVParsing < Minitest::Test
  ...
  def test_std_lib_csv
    [ ["\t", ["\t"]],
      ...
      [";,;", [";", ";"]] ].each do |csv_test|
      assert_equal(csv_test.last, CSWat.parse_line(csv_test.first))
    end
  ...
  def test_aras_edge_cases
    [ [%Q{a,b},               ["a", "b"]],
      ...
      [%Q{"\r\n,",},          ["\r\n,", nil]] ].each do |edge_case|
        assert_equal(edge_case.last, CSWat.parse_line(edge_case.first))
      end
  end
  ...
  def test_non_regex_edge_cases
    ...
    assert_raise(CSWat::MalformedCSVError) do
      CSWat.parse_line("1,\"23\"4\"5\", 6")
    end
  end

  def test_malformed_csv
    assert_raise(CSWat::MalformedCSVError) do
      CSWat.parse_line("1,2\r,3", row_sep: "\n")
    end
    ...
    assert_raise(CSWat::MalformedCSVError) { CSWat.parse_line('1,2,"3...') }
